...
const Router = () => {
  ...
  const FinalRoute = props => {
    ...
    if (
      (!isUserAuthenticated() && route.meta === undefined) ||
      (!isUserAuthenticated() && route.meta && !route.meta.authRoute && !route.meta.publicRoute)
    ) {
      /**
    ...
    else if (isUserAuthenticated() && getLoggedInUser().student.status === 'new') {
        ...
        <Route
          ...
          render={() => {
            ...
            if (isUserAuthenticated()) {
              return user.student.status != 'new' ? <Redirect to={DefaultRoute} /> : <Redirect to={GetStartedRoute} />
            } else {
              return <Redirect to='/login' />
            }
          }}
