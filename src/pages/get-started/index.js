...
const GetStartedPage = (props) => {
    ...
    useEffect(() => {
        if (isUpdateMeeting && !props.updateMeetingLoading && !props.updateMeetingError) {
            closeMeeting()
            notifySuccess("Update Meeting", `Meeting ${meetingAction} successfully`)
        }
        else if (isUpdateMeeting && !props.updateMeetingLoading && props.updateMeetingError) {
    ...
    const meetingComponent = () => {
        return <div className="mt-4 mb-4 d-flex align-items-center justify-content-center">
            {
                (props.meetingError
                    ...
                    <Row>
                        <Col sm={12} md={2} className="mt-1">
                            <div className="text-center">
                                <Avatar className='box-shadow-1 avatar-border'
                                    img={GET_IMAGE_URL(props.meeting.participants.find(u => u.user.userId != user.userId).user.profilePicture)}
                                    size='lg' />
                            </div>
                        </Col>
                        <Col sm={12} md={5} className="mt-1">
                            <h5>
                                {props.meeting.participants.find(u => u.user.userId != user.userId).user.name}
                            </h5>
                            <div className="mt-25">
                                <Badge
                                    pill
                        ...
                        <Col sm={12} md={5} className="mt-1">
                            <Media>
                                ...
                                />
                                <Media body>
                                    <h6 className='mb-0'><DateTime dateTime={props.meeting.scheduledAt} format="ddd DD MMM, YYYY" /></h6>
                                    <small><DateTime dateTime={props.meeting.scheduledAt} type="time" /></small>
                                </Media>
                            </Media>
                        </Col>
                    </Row>
                    ...
                    <div className="mt-1 text-right">
                                ...
                                <DropdownMenu>
                                    {
                                        ...
                                        <>
                                            <DropdownItem
                                                href='/' tag='a'
                                                onClick={e => onMeetingAction(e, props.meeting.meetingId, MeetingActions.Reject)}
                                            >
                                                Reject
                                            </DropdownItem>
                                            <DropdownItem
                                    ...
                                    }
                                    {
                                        ...
                                        <DropdownItem
                                            href='/' tag='a'
                                            onClick={e => onMeetingAction(e, props.meeting.meetingId, MeetingActions.Cancel)}
                                        >
                                            Cancel
                                        </DropdownItem>
                                    }
                        ...
                        }
                        {
                            ...
                            <Button.Ripple
                                ...
                                color='primary'
                                className="ml-2"
                                onClick={e => onMeetingAction(e, props.meeting.meetingId, MeetingActions.Accept)}
                            >
                                Accept
                            </Button.Ripple>
                        }
                    ...
                    <ModalBody className="p-2">
                        ...
                        <Form
                            ...
                            <div className="text-right">
                                <Button.Ripple className="mr-1" color='primary' outline onClick={() => closeMeeting()}>Cancel</Button.Ripple>
